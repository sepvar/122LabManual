...
s|\\\([sub]*section\)[^{]*{\(.*\)}\\label{\(.*\)}\(.*\)|</\1 xml:id="\3">\n<\1><title>\2</title>\4|g
s|\\\([sub]*section\)[^{]*{\(.*\)}\(.*\)|</\1>\n<\1><title>\2</title>\3|g
s/{ss:/{s:/g
s/{sss:/{ss:/g
s|\(.*\)(\$\(.*\)\$)\(.*\)|\1<m>(\2)</m>\3|g
...
s|\\includegraphics\[\(.*\)\]{\(.*\)}|<!-- REMOVE latex-image-code AND REPLACE image WITH (Note: width should be a percentage) -->\n<image xml:id="i-FIGURE-NAME" width="\1" source="./\2">|g
s|\\caption\[\(.*\)\]{\(.*\)}|<!-- SHORT VERSION -->\n<!-- <caption>\1</caption> -->\n<!-- LONG VERSION -->\n<caption>\2</caption>|g
s|\\caption{\(.*\)}|<caption>\1</caption>|g
s|\\end{figure}|</latex-image-code>\n</image>\n</figure>|g
...
s|\\item\[\]|</p><p>|g
s|\\item[ ]*\[\(.*\)\]|</p></li><li><title>\1</title><p>|g
s|\\item[ ]*\\label{\([a-zA-Z0-9\-]*\)}|</p></li><li xml:id="\1"><p>|g
s|\\item|</p></li><li><p>|g
s|\\end{question}|</p></li>\n</ol>\n</p></statement>\n</exercise>|g
